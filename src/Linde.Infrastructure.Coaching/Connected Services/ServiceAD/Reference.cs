...
namespace ServiceAD
{
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceAD.PrxMxServicesSoap")]
    public interface PrxMxServicesSoap
    {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ServiceAD.userDataResponseUserDataResult> userDataAsync(string user, string no_emp);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/userDataJDE", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ServiceAD.userDataJDEResponseUserDataJDEResult> userDataJDEAsync(string noAB_JDE);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/getAppDetail", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ServiceAD.getAppDetailResponseGetAppDetailResult> getAppDetailAsync(string idApp);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface PrxMxServicesSoapChannel : ServiceAD.PrxMxServicesSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class PrxMxServicesSoapClient : System.ServiceModel.ClientBase<ServiceAD.PrxMxServicesSoap>, ServiceAD.PrxMxServicesSoap
    {
        ...
        public System.Threading.Tasks.Task<ServiceAD.userDataResponseUserDataResult> userDataAsync(string user, string no_emp)
        {
            return base.Channel.userDataAsync(user, no_emp);
        }
        
        public System.Threading.Tasks.Task<ServiceAD.userDataJDEResponseUserDataJDEResult> userDataJDEAsync(string noAB_JDE)
        {
            return base.Channel.userDataJDEAsync(noAB_JDE);
        }
        
        public System.Threading.Tasks.Task<ServiceAD.getAppDetailResponseGetAppDetailResult> getAppDetailAsync(string idApp)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.PrxMxServicesSoap))
            {
                return new System.ServiceModel.EndpointAddress("http://mlgmty00is04/PrxMxServices/PrxMxServices.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.PrxMxServicesSoap12))
            {
                return new System.ServiceModel.EndpointAddress("http://mlgmty00is04/PrxMxServices/PrxMxServices.asmx");
